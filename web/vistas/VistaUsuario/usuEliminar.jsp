            ...
            <table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="modificarusu.jsp?id=<%= rs.getInt("id_usuarios")%>"><i class="fas fa-edit"></i></a></td>
                        <td><a href="elimianrusu.jsp?id=<%= rs.getInt("id_usuarios")%>"><i class="fas fa-times"></i></a></td>
                    </tr>
